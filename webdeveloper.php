<!DOCTYPE html>
  ...
  <div class ="computer-image">
	...
	<p>I love to build beautiful, efficient, and responsive websites.</p>

	<p>Much of my work has been related to libraries and archival collections. One of my recent projects was to improve user experience in the <a href="https://archives.lib.duke.edu/">Rubenstein Library's collection guide platform</a>. The platform is based on the open source projects <a href="https://library.stanford.edu/projects/arclight">ArcLight</a> and <a href="https://projectblacklight.org/">BlackLight</a>. <a href="v1.3.0_arclight_release_notes.pdf">Click to view release notes for my latest contributions to the site.</a>

	<p>I have experience working on sites that use a variety of frameworks including the MEAN stack, the LAMP stack, and Ruby on Rails. Future goals include becoming more expert at these frameworks, writing more tests (including creating automated accessibility tests), and learning more about DevOps tools such as Docker and Dependabot.</p>

	<h2>Fluencies</h2>
	<ul class="fluencies">
		<li>Programming languages: HTML5, CSS3, JavaScript, TypeScript, SQL, PHP, Python, Swift</li>
		<li>Databases: Access, Oracle, mySQL, MongoDB</li>
		<li>Frameworks: MEAN stack (MongoDB, Node.js, Angular, and Express)</li>
		<li>Operating systems: Mac, Microsoft, Linux, Unix</li>
		<li>Other: Git, GitHub, GitLab, Jira, AdobeXD, Adobe Dreamweaver, Photoshop, Postman, RSpec, axe DevTools</li>
	</ul>

  <h2>Portfolio</h2>
  <p>You can view a few of my projects on <a href="https://github.com/laurinpenland">GitHub.</a></p>
	...
	<footer>
		<p>Website created by Laurin Penland. The background photograph is a digital image of "Equivalents," by Alfred Stieglitz, courtesy of the <a href="http://www.getty.edu/art/collection/objects/62747/alfred-stieglitz-equivalents-american-1924/" target="_blank"><i>Getty's Open Content Program</i></a>.
	</footer>
	</div>
	</body>
